namespace AwesomeLogger.Monitor
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.MonitorServiceInstaller.ServiceName = "AwesomeLogger Monitor Service";
            this.MonitorServiceInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;
            this.MonitorServiceInstaller.AfterInstall += new System.Configuration.Install.InstallEventHandler(this.ClickberryServiceInstaller_AfterInstall);
            // 
            // ProjectInstaller
            // 
