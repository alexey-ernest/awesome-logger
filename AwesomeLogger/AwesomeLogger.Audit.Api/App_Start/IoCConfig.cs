...
namespace AwesomeLogger.Audit.Api
{
    ...
    public class IoCConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            // DAL
            container.RegisterType<AuditDbContext, AuditDbContext>(new PerRequestLifetimeManager());
            container.RegisterType<IPatternMatchRepository, PatternMatchRepository>(new PerRequestLifetimeManager());
        }
