...
The system is dedicated and designed without Single-Point-Of-Failure (SPOF). Each component can be scaled and load balanced. For Audit DB recommended NoSQL database because of high load and log-like structure. Cassandra can be perfectly meet this data usage pattern.
